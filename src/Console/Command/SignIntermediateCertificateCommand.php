<?php
/**
 * SignIntermediateCertificateCommand
 *
 *
...
use Cafe\Gitlab\Blackfriday\Ca\IntermediateCertificateController;
...
class SignIntermediateCertificateCommand extends Command
{
    ...
    {
        $cc = new IntermediateCertificateController(new DomainName());
