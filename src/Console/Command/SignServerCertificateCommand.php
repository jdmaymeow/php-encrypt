...
use Cafe\Gitlab\Blackfriday\Ca\ServerCertificateController;
...
class SignServerCertificateCommand extends Command
{
    ...
    {
        $cc = new ServerCertificateController(new DomainName());
